...
- [Bracket Pair Colorizer 2](https://marketplace.visualstudio.com/items?itemName=CoenraadS.bracket-pair-colorizer-2) - See the beautiful brackets in the picture below 
    - ![bracket-colorizer-2](.attachements/bracket-colorizer-2.png)
